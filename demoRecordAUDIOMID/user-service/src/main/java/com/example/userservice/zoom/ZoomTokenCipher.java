...
public class ZoomTokenCipher {
    ...
    public ZoomTokenCipher(ZoomOAuthProperties properties) {
    ...
    public EncryptedToken encrypt(String refreshToken) {
        ...
        try {
            ...
            throw new IllegalStateException("Unable to encrypt Zoom refresh token", ex);
        }
    }
    ...
    public String decrypt(String encryptedToken, String encodedIv, String tokenKid) {
        ...
        if (!properties.getTokenEncryptionKid().equals(tokenKid)) {
            throw new ZoomOAuthException(ZoomOAuthError.ZOOM_TOKEN_KEY_UNAVAILABLE);
        }
        try {
            Cipher cipher = Cipher.getInstance("AES/GCM/NoPadding");
            cipher.init(
            ...
            throw new ZoomOAuthException(ZoomOAuthError.ZOOM_TOKEN_DECRYPTION_FAILED, ex);
        }
    }
    ...
    private SecretKeySpec key() {
        ...
        try {
            ...
            throw new ZoomOAuthException(ZoomOAuthError.ZOOM_OAUTH_NOT_CONFIGURED, ex);
        }
