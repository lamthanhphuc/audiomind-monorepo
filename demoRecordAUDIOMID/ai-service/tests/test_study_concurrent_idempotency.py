...
def _build_sqlite_schema(engine) -> None:
    ...
    Table(
        ...
        Column("subject_membership_hash", String(64)),
        ...
        Column("quota_confirmed_at", DateTime),
        Column("dispatch_attempt_count", Integer, nullable=False, default=0),
        Column("last_dispatch_error", Text),
        Column("last_dispatch_error_at", DateTime),
        Column("next_dispatch_retry_at", DateTime),
