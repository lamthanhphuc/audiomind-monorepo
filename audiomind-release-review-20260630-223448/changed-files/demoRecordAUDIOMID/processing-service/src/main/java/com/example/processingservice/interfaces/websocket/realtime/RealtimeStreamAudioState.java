...
public final class RealtimeStreamAudioState {
    ...
    private boolean validAudioReceived;
    ...
    public boolean validAudioReceived() {
        return validAudioReceived;
    }

    public void setValidAudioReceived(boolean validAudioReceived) {
        this.validAudioReceived = validAudioReceived;
    }
